...
function Page({children}:{children:React.ReactNode}) { return <div className="min-h-screen bg-[#F3EFE7] text-[#243538]"><Header/>{children}<Footer/></div>; }
