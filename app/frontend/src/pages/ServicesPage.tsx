...
const fallbackServices = [
  { id: 'cleaning', mark: '/assets/brand/v2/symbol-cleaning.svg', photo: 'post-renovation-cleaning' as DocumentaryId, name_en: 'Home cleaning', name_he: 'ניקיון הבית', desc_en: 'Careful home cleaning with a clear written scope and accountable follow-through.', desc_he: 'ניקיון בית מוקפד עם היקף כתוב וברור ומעקב אחראי.' },
